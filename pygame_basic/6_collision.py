...
# enemy character
enemy_file = current_dir + "/resource/enemy.png"
enemy = pygame.image.load(enemy_file)
enemy_size = enemy.get_rect().size
enemy_width = enemy_size[0]
enemy_height = enemy_size[1]
enemy = pygame.transform.scale(enemy, (enemy_width / 4, enemy_height / 4))
enemy_size = enemy.get_rect().size
enemy_width = enemy_size[0]
enemy_height = enemy_size[1]
enemy_x_pos = 0
...
while running:
    ...
    # update rect for collision event
